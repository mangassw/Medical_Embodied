...
#ifndef MPPI_CONTROLLER_ROS__TOOLS__NOISE_GENERATOR_HPP_
#define MPPI_CONTROLLER_ROS__TOOLS__NOISE_GENERATOR_HPP_
...
public:
  ...
  void initialize(
    ...
    bool is_holonomic, const std::string & name, Parameters * parameters);
...
#endif  // MPPI_CONTROLLER_ROS__TOOLS__NOISE_GENERATOR_HPP_
