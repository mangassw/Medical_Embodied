...
#ifndef MPPI_CONTROLLER_ROS__MOTION_MODELS_HPP_
#define MPPI_CONTROLLER_ROS__MOTION_MODELS_HPP_
...
#include "mppi_controller_ros/models/control_sequence.hpp"
...
public:
  /**
    ...
    */
  explicit AckermannMotionModel(Parameters * parameters, const std::string & name)
  {
    min_turning_r_ = parameters->ackermann_constraints_min_turning_r;
  }
...
#endif  // MPPI_CONTROLLER_ROS__MOTION_MODELS_HPP_
