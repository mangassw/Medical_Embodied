...
#include "mppi_controller_ros/critics/path_follow_critic.hpp"
...
void PathFollowCritic::initialize(Parameters * params)
{
 power_ = params->path_follow_cost_power;
 weight_ = params->path_follow_cost_weight;
 threshold_to_consider_ = params->path_follow_threshold_to_consider;
 offset_from_furthest_ = static_cast<size_t>(params->path_follow_offset_from_furthest);
}
