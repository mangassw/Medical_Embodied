...
#include <cmath>
#include "mppi_controller_ros/critics/obstacles_critic.hpp"
#include <costmap_2d/inflation_layer.h>
namespace mppi::critics
{

void ObstaclesCritic::initialize(Parameters * params)
{
  consider_footprint_ = params->obstacles_consider_footprint;
  power_ = params->obstacles_cost_power;
  repulsion_weight_ = params->obstacles_repulsion_weight;
  critical_weight_ = params->obstacles_critical_weight;
  collision_cost_ = params->obstacles_collision_cost;
  collision_margin_distance_ = params->obstacles_collision_margin_distance;
  near_goal_distance_ = params->obstacles_near_goal_distance;
  inflation_layer_name_ = params->obstacles_inflation_layer_name;
  inflation_radius_ = params->obstacles_inflation_radius;
  inflation_scale_factor_ = params->obstacles_inflation_scale_factor;
...
CollisionCost ObstaclesCritic::costAtPose(float x, float y, float theta)
{
  ...
  {
    cost = static_cast<float>(collision_checker_->footprintCost(
