...
#include "mppi_controller_ros/critics/goal_angle_critic.hpp"

namespace mppi::critics
{

void GoalAngleCritic::initialize(Parameters * params)
{
  power_ = params->goal_angle_cost_power;
  weight_ = params->goal_angle_cost_weight;
  threshold_to_consider_ = params->goal_angle_threshold_to_consider;
