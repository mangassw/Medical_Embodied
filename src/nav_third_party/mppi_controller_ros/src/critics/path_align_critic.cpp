...
#include "mppi_controller_ros/critics/path_align_critic.hpp"

namespace mppi::critics
{

void PathAlignCritic::initialize(Parameters * params)
{
  power_ = params->path_align_cost_power;
  weight_ = params->path_align_cost_weight;
  max_path_occupancy_ratio_ = params->path_align_max_path_occupancy_ratio;
  offset_from_furthest_ = static_cast<size_t>(params->path_align_offset_from_furthest);
  trajectory_point_step_ = params->path_align_trajectory_point_step;
  threshold_to_consider_ = params->path_align_threshold_to_consider;
  use_path_orientations_ = params->path_align_use_path_orientations;
