    ...
    const std::string & frame_id, Parameters * parameters)
{
  ...
  trajectory_step_ = static_cast<size_t>(parameters_->trajectory_visualizer_trajectory_step);
  time_step_ = static_cast<size_t>(parameters_->trajectory_visualizer_time_step);
